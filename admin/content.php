...
class Admin_Content
{
	 ...
	 */
	 ...
	 public static function info_content()
	 {
		 ...
		 <a href="<?php echo plugins_url( 'logs/iam_log.txt', dirname(__FILE__) ); ?>">email log file</a>
		 <a href="<?php echo plugins_url( 'logs/iam_email_log.txt', dirname(__FILE__) ); ?>">event log file</a>
