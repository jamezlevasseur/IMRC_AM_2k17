...
class Admin_Content
{
	 ...
	 */
	 ...
	 public static function info_content()
	 {
		 ...
		 <a href="<?php echo plugins_url( 'logs/iam_log.txt', dirname(__FILE__) ); ?>">email log file</a> <br />
		 <a href="<?php echo plugins_url( 'logs/iam_email_log.txt', dirname(__FILE__) ); ?>">event log file</a> <br />
	...
	{
		?>
			<div class="wrap iam-reservation-wrap" data-facility="<?php echo iam_output(json_encode($this->facility)); ?>">
